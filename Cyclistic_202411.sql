-- Select all our bike trip records for Nov 2024

SELECT *
FROM [Cyclistic].[dbo].[202411-cyclistic-tripdata];
...
GROUP BY ride_id HAVING COUNT(*) > 1;
 ...
 sp_rename '[Cyclistic].[dbo].[202411-cyclistic-tripdata].ride_id',
           'trip_id',
           'COLUMN';

 sp_rename '[Cyclistic].[dbo].[202411-cyclistic-tripdata].rideable_type',
           'bike_type',
           'COLUMN';

 sp_rename '[Cyclistic].[dbo].[202411-cyclistic-tripdata].started_at',
           'start_time',
           'COLUMN';

 sp_rename '[Cyclistic].[dbo].[202411-cyclistic-tripdata].ended_at',
           'end_time',
           'COLUMN';

 sp_rename '[Cyclistic].[dbo].[202411-cyclistic-tripdata].member_casual',
           'user_type',
           'COLUMN';
...
ALTER TABLE [Cyclistic].[dbo].[202411-cyclistic-tripdata] ADD ride_length TIME;

 -- Add a day of the week column. Our days of the week will be presented as strings, so we'll use NVARCHAR

ALTER TABLE [Cyclistic].[dbo].[202411-cyclistic-tripdata] ADD day_of_week NVARCHAR(20);

 -- Calculate the ride_length for each journey and populate the newly created column

UPDATE [Cyclistic].[dbo].[202411-cyclistic-tripdata]
...
ALTER TABLE [Cyclistic].[dbo].[202411-cyclistic-tripdata] ADD time_of_day NVARCHAR(20);


ALTER TABLE [Cyclistic].[dbo].[202411-cyclistic-tripdata] ADD season_of_year NVARCHAR(20);
