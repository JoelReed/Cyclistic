-- Select all our bike trip records for Oct 2024
  ...
  sp_rename '[Cyclistic].[dbo].[202410-cyclistic-tripdata].ride_id', 'trip_id', 'COLUMN';
  sp_rename '[Cyclistic].[dbo].[202410-cyclistic-tripdata].rideable_type', 'bike_type', 'COLUMN';
  sp_rename '[Cyclistic].[dbo].[202410-cyclistic-tripdata].started_at', 'start_time', 'COLUMN';
  sp_rename '[Cyclistic].[dbo].[202410-cyclistic-tripdata].ended_at', 'end_time', 'COLUMN';
  sp_rename '[Cyclistic].[dbo].[202410-cyclistic-tripdata].member_casual', 'user_type', 'COLUMN';
  ...
  DELETE FROM [Cyclistic].[dbo].[202410-cyclistic-tripdata]
  ...
  ALTER TABLE [Cyclistic].[dbo].[202410-cyclistic-tripdata]
